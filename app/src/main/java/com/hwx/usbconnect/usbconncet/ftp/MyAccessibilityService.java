...
public class MyAccessibilityService extends AccessibilityService {
    ...
    private static final HashSet<String> installedWhitelList = new HashSet<String>();
    private static final HashSet<String> unInstalledWhitelList = new HashSet<String>();
