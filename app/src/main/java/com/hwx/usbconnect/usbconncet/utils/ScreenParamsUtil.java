...
*
*/
public class ScreenParamsUtil {
private final String TAG = "SystemParams";
private static ScreenParamsUtil params;
...
* @param activity
*/
private ScreenParamsUtil(Activity activity) {
...
* @return
*/
public static ScreenParamsUtil getInstance(Activity activity) {
if (params == null) {
params = new ScreenParamsUtil(activity);
}
return params;
}
...
* @return
*/
public static ScreenParamsUtil getNewInstance(Activity activity) {
if (params != null) {
params = null;
}
